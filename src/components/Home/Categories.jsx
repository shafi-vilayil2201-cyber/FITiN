...
const Categories = () => {
    ...
    return (
        ...
        <div className="p-0 md:p-20 w-[95%] min-h-screen md:h-min mx-auto  rounded-2xl pt-0">
                ...
                <div className="flex flex-wrap justify-center gap-5 w-full">
                    {categories.map((cat, index) => (
                        <div
                            ...
                            className={`relative flex flex-col items-center justify-center w-64 h-72 md:w-30 md:h-30 rounded-3xl cursor-pointer overflow-hidden transition-all duration-500 transform 
